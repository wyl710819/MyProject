...
import com.routon.smartcampus.answerrelease.BluetoothListAdapter;
...
public class BluetoothFragment extends Fragment {
	...
	public void init(View view) {
		...
		mRootLL=(LinearLayout) view.findViewById(R.id.ll_bluetooth);
		mRootLL.setBackgroundColor(Color.parseColor("#f5f5f5"));
