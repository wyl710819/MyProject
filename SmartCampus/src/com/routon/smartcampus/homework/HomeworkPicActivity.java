...
public class HomeworkPicActivity extends Activity{
	
	private ViewPager viewPager;
	private ArrayList<FeedbackHomeworkFileBean> mPicUrlList;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mPicUrlList =(ArrayList<FeedbackHomeworkFileBean>) getIntent().getSerializableExtra(com.routon.smartcampus.utils.MyBundleName.BADGE_REMARK_PIC_LIST);
...
//			delete_view.setTextSize(24);
        ...
        imageLoader.init(ImageLoaderConfiguration.createDefault(HomeworkPicActivity.this));
