...
public class ImgClassListviewAdapter extends BaseAdapter {

	private Context mContext;
	private List<QueryClassHomeworkBean.HomeworkResourse> mList;
	...
	public interface MyOnPlayClickListener{
		 public  void playClick(View v,int position,ImageView imgView,TextView tvView,List<QueryClassHomeworkBean.HomeworkResourse> mList); 
	}
	public void setPlayClickListener(MyOnPlayClickListener mPlayClickListener){
		this.mPlayClickListener=mPlayClickListener;
	}
	public ImgClassListviewAdapter(
